...
.result-label  { font-size: 0.85rem; font-weight: 600; text-transform: uppercase; letter-spacing: 2px; color: rgba(255,255,255,0.65) !important; -webkit-text-fill-color: rgba(255,255,255,0.65) !important; margin-bottom: 0.4rem; }
.result-amount { font-family: 'Poppins', sans-serif; font-size: 3rem; font-weight: 800; color: #ffffff !important; -webkit-text-fill-color: #ffffff !important; line-height: 1.1; }
.result-tier   { font-size: 0.95rem; font-weight: 500; margin-top: 0.6rem; color: rgba(255,255,255,0.80) !important; -webkit-text-fill-color: rgba(255,255,255,0.80) !important; }
...
.stat-pill .lbl { font-size: 0.72rem; color: rgba(255,255,255,0.55) !important; -webkit-text-fill-color: rgba(255,255,255,0.55) !important; text-transform: uppercase; letter-spacing: 0.8px; }

.custom-divider { border: none; border-top: 1px solid rgba(255,255,255,0.10); margin: 1.2rem 0 0.8rem; }

.footer { text-align: center; color: rgba(255,255,255,0.35) !important; -webkit-text-fill-color: rgba(255,255,255,0.35) !important; font-size: 0.78rem; margin-top: 2rem; padding-top: 1rem; border-top: 1px solid rgba(255,255,255,0.07); }
...
with left:
    ...
    # Height / Weight → auto BMI (read-only display)
    ...
    with h3:
        ...
        bmi = float(min(max(bmi, 10.0), 60.0))
        st.markdown(f"""
        <div class="bmi-box">
            <div class="bmi-val">{bmi}</div>
            <div class="bmi-lbl">BMI (kg/m²)</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class="glass-card">
        ...
        <p style="color:rgba(255,255,255,0.55);-webkit-text-fill-color:rgba(255,255,255,0.55);font-size:0.78rem;margin:-0.4rem 0 1rem 0;">
...
with right:
    ...
    <div class="glass-card">
        ...
        <p style="color:rgba(255,255,255,0.70);-webkit-text-fill-color:rgba(255,255,255,0.70);font-size:0.88rem;line-height:1.7;margin:0;">
            ...
            Enter height and weight — BMI is calculated automatically and fed into the model.
        </p>
        <div class="stat-row">
    ...
    if predict_btn:
        try:
            ...
            <div class="result-card {card_cls}">
                ...
                <p style="font-size:0.82rem;color:#ffffff !important;-webkit-text-fill-color:#ffffff !important;margin:0;background:rgba(255,255,255,0.10);border:1px solid rgba(255,255,255,0.25);border-radius:8px;padding:0.5rem 0.8rem;">
